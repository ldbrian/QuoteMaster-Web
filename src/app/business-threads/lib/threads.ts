...
import type { DashboardThread } from "../components/DashboardClient";

export type BusinessThreadRecord = Awaited<ReturnType<typeof getBusinessThreads>>[number];
...
export function serializeThread(thread: BusinessThreadRecord): DashboardThread {
...
export async function getBusinessThreads(ownerUserId?: string) {
  return withTimeout(
