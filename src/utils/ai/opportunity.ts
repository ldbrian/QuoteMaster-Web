...

{
  ...
  "confidenceScore": "分析可信度 0-100，根据输入信息完整度判断：提供了公司名+官网+产品描述+市场信息则 85+；缺少官网 60-70；只有公司名 40-50；只有公司名且模糊 20-30",
  "confidenceReason": "可信度评分的原因说明，例如：'提供了官网、产品信息和市场定位，分析依据充分'",
